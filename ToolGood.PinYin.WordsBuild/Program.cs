...
namespace ToolGood.PinYin.WordsBuild
{
    internal class Program
    {
        ...
        private static List<PinYinWords> SimplifyPinYinWords(HashSet<PinYinWords> pyws)
        {
        ...
        private static void SimplifyPinYinWords(HashSet<PinYinWords> pyws, List<PinYinWords> list, int length)
        {
        ...
        private static void GetPinYinWords(string file, HashSet<PinYinWords> pyws)
        {
        ...
        private static void SimplifyPinYin(List<Tuple<string, string>> list, HashSet<PinYinWords> pyws, int length)
        {
